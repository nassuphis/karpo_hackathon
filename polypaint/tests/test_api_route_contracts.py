...
class TestApiRouteContracts(unittest.TestCase):
    ...
    def test_manifest_parser_sanity(self):
        ...
        self.assertEqual(set(frontend["solver_lores_endpoints"]), {"aberth_mt", "companion_matrix"})
        self.assertEqual(set(frontend["solver_dispatch_targets"]), {"aberth_mt", "companion_matrix"})
