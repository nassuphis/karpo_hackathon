...
"${TEST_PYTHON[@]}" -m pytest \
    ...
    tests/test_giga_2877_variants.py \
    tests/test_giga_2878_coeff_program.py \
    tests/test_giga_2880_coeff_program.py \
    tests/test_giga_2883_coeff_program.py \
    ...
    tests/test_giga_0164_coeff_program.py \
    tests/test_giga_p11b3a_coeff_program.py \
    tests/test_giga_outflow_coeff_program.py \
    tests/test_giga_2864_coeff_program.py \
    tests/test_giga_2864_variants.py \
    tests/test_giga_2921_coeff_program.py \
    tests/test_giga_2920_coeff_program.py \
    tests/test_giga_2920_lite_coeff_program.py \
    tests/test_giga_2897_coeff_program.py \
    tests/test_giga_2898_family_coeff_programs.py \
    tests/test_giga_2891_coeff_program.py \
    tests/test_giga_2892_coeff_program.py \
    tests/test_giga_2893_family_coeff_programs.py \
    tests/test_giga_259_coeff_program.py \
    tests/test_poly_sheet.py \
    tests/test_giga_early_t1_coeff_programs.py \
    tests/test_giga_early_t2_coeff_programs.py \
    tests/test_giga_early_t3_coeff_programs.py \
    tests/test_giga_early_t45_coeff_programs.py \
    tests/test_giga_17_coeff_program.py \
    ...
    tests/test_view_raster_tool.py \
