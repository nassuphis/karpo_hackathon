...
ALLOWED_EXTERNAL_VARS = {
    ...
    "VIEW_SNAP_RASTER_BINARY_SHA256", "VIEW_SNAP_ASSEMBLER_BINARY_SHA256",
    "VIEW_SNAP_ENCODER_BINARY_SHA256", "VIEW_SNAP_RASTER_PACKAGE_HASH",
    "VIEW_SNAP_FINALIZE_PACKAGE_HASH", "VIEW_SNAP_LIBVIPS_LAYER_ARN",
    "VIEW_SNAP_RUNTIME", "VIEW_SNAP_ARCHITECTURE",
    "VIEW_SNAP_RASTER_TIMEOUT_SECONDS", "VIEW_SNAP_FINALIZE_TIMEOUT_SECONDS",
    "VIEW_SNAP_RASTER_WORKERS", "VIEW_SNAP_FINALIZE_WORKERS",
}
