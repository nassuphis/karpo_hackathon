...
class TestDeployPackaging(unittest.TestCase):
    ...
    def test_known_regressions_are_covered(self):
        ...
        self.assertIn("handler_color_repalette.py", packaged["handler_recolor_from_raw.py"])
        ...
        self.assertIn("pixbinassemble", packaged["handler_finalize_mt.py"])
        self.assertIn("pixel_bins_render", packaged["handler_finalize_mt.py"])
        self.assertIn("raw2jpeg", packaged["handler_finalize_mt.py"])
        ...
        self.assertIn('aarch64-linux-musl-gcc -O3 -static -pthread -o lambda/assemble_greyscale lambda/assemble_greyscale.c -lm', DEPLOY_TEXT)
