# LEGACY ORACLE: frozen Param Program source parser for M3/M0 equivalence tests; do not import in production.
...
from param_program_chain_legacy import (
    compile_param_program_chain,
    display_param_program_chain,
    legacy_registry,
)
from program_source_core_legacy import (
