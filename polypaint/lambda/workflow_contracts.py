...
RENDER_COEFF_STITCH_TASK_PAYLOAD = {
    "job_id.$": "$.job_id",
    "task_id.$": "States.Format('render_{}_coeff_bilevel_stitch', $.run_id)",
    "n_tile_cols.$": "$.plan.grid.n_tile_cols",
    "n_tile_rows.$": "$.plan.grid.n_tile_rows",
    "width.$": "$.plan.grid.pix",
