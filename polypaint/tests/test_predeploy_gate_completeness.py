...
ALLOWED_UNGATED = {
    ...
    "test_color_repalette_handler.py",
    "test_companion_matrix.py",
    "test_compute_fused.py",
    "test_compute_status_handler.py",
    "test_deepzoom_export_handler.py",
    "test_deepzoom_from_raw.py",
    "test_deepzoom_viewport_math.py",
    "test_deploy_manifest_validator.py",
    ...
    "test_palette_chunk_handler.py",
    "test_palette_chunk_mt_parity.py",
    "test_palette_debug_handler.py",
    "test_palette_finalize_handler.py",
    "test_palette_names.py",
    "test_palette_orchestrator.py",
    "test_palette_render_plan.py",
    "test_palette_workflow_definition.py",
    "test_param_dump.py",
    "test_pipeline.py",
    "test_png_export.py",
    "test_png_export_handler.py",
    ...
    "test_render_orchestrator.py",
    "test_render_status.py",
    "test_repalette_handler.py",
    "test_resize_artifact_handler.py",
