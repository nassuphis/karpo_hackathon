...
COLOR_TRI_STRINGS = {
    ...
    # --- Classic Gucci (from attached swatch image) ---
    # extracted median-ish swatch hexes:
    # 9F7C6B (warm taupe)  D0B7B1 (powder blush)
    # 6B6393 (dusty iris)  8C6E64 (cocoa taupe)
    # 4B403C (espresso)    8EA8B1 (dusty blue)
    # B6BEC2 (cool stone)  8A776F (mushroom)
    # E2AAA0 (peach blush) 6A4E5A (plum brown)
    # B48986 (rosewood)    B0928F (putty)

    "beauty_gucci_taupe_blush":      "4B403C:9F7C6B:D0B7B1",
    "beauty_gucci_espresso_putty":   "4B403C:B0928F:B6BEC2",
    "beauty_gucci_mushroom_blush":   "8A776F:B0928F:E2AAA0",
    "beauty_gucci_rosewood_blush":   "6A4E5A:B48986:E2AAA0",
    "beauty_gucci_plum_powder":      "6A4E5A:D0B7B1:B6BEC2",
    "beauty_gucci_cocoa_powder":     "8C6E64:D0B7B1:B6BEC2",

    "beauty_gucci_iris_stone":       "6B6393:B6BEC2:D0B7B1",
    "beauty_gucci_iris_putty":       "6B6393:B0928F:D0B7B1",
    "beauty_gucci_iris_blush":       "6B6393:D0B7B1:E2AAA0",

    "beauty_gucci_dustyblue_stone":  "8EA8B1:B6BEC2:D0B7B1",
    "beauty_gucci_dustyblue_putty":  "8EA8B1:B0928F:B6BEC2",
    "beauty_gucci_dustyblue_peach":  "8EA8B1:D0B7B1:E2AAA0",

    "beauty_gucci_taupe_peach":      "4B403C:D0B7B1:E2AAA0",
    "beauty_gucci_espresso_peach":   "4B403C:B48986:E2AAA0",
    "beauty_gucci_cocoa_peach":      "8C6E64:B48986:E2AAA0",
    "beauty_gucci_mushroom_stone":   "4B403C:8A776F:B6BEC2",

    # --- Classic Gucci (from the 5-bar image) ---
    # extracted stripe hexes:
    # E7E689 (pale lemon)  8B2C79 (gucci purple)
    # 3B7093 (slate/denim blue)  EC9E91 (salmon pink)
    # 486C44 (deep green)

    "classic_gucci_lemon_purple":        "8B2C79:3B7093:E7E689",
    "classic_gucci_green_lemon":         "486C44:3B7093:E7E689",
    "classic_gucci_green_pink":          "486C44:3B7093:EC9E91",
    "classic_gucci_purple_pink":         "8B2C79:3B7093:EC9E91",
    "classic_gucci_purple_lemon":        "8B2C79:EC9E91:E7E689",
    "classic_gucci_green_purple":        "486C44:3B7093:8B2C79",

    "classic_gucci_lemon_blue_pink":     "3B7093:E7E689:EC9E91",
    "classic_gucci_lemon_blue_green":    "3B7093:E7E689:486C44",
    "classic_gucci_purple_blue_green":   "8B2C79:3B7093:486C44",
    "classic_gucci_purple_pink_green":   "8B2C79:EC9E91:486C44",

    # --- Leaves / Ginkgo-inspired palettes ---
    # extracted + consolidated hues:
    # fresh spring green, lime/chartreuse, deep leaf green,
    # olive, golden yellow, autumn amber, muted sage

    "leaves_spring_fresh":     "2E7D32:9CCC65:E6EE9C",  # deep leaf → fresh green → pale spring
    "leaves_lime_canopy":      "33691E:AFB42B:E6EE9C",  # forest → lime → light chartreuse
    "leaves_green_gold":      "2F5D3A:7CB342:F9E547",  # deep green → living green → ginkgo yellow
    "leaves_ginkgo_yellow":   "558B2F:C0CA33:FDD835",  # olive green → ginkgo → golden leaf
    "leaves_summer_canopy":   "1B5E20:66BB6A:C8E6C9",  # dark canopy → leaf green → airy light
    "leaves_fresh_sage":      "3E6B4E:9DB7A1:E8F0EC",  # cool green → sage → pale mist

    "leaves_olive_amber":     "4E5B31:A4B86A:F2C94C",  # olive shadow → leaf → warm amber
    "leaves_autumn_ginkgo":   "6B8E23:C9B458:F4D03F",  # olive → dry yellow → autumn gold
    "leaves_autumn_warm":     "5A6B2E:BFAE4E:E6C229",  # late-season leaf → warm yellow
    "leaves_fall_contrast":   "2E4D2C:9E9D24:FBC02D",  # deep green → olive → strong yellow

    "leaves_forest_sun":      "1B3A2B:4CAF50:F9E547",  # shadow forest → sunlit leaf → yellow
    "leaves_moss_light":      "2F4F2F:8FBC8F:E0F2E9",  # moss → soft green → pale light
    "leaves_sage_gold":       "556B5F:A3B18A:F2E085",  # gray-green → sage → muted gold

    "leaves_ginkgo_classic":  "3A5F0B:C7C94E:F6E45C",  # deep green → ginkgo yellow → luminous leaf
    "leaves_leafpaper":       "2E4D2C:DDE5B6:F5F5E9",  # leaf shadow → dry leaf → paper light
