...
class TestPaletteWorkflowDefinition(unittest.TestCase):
    ...
    def test_solve_score_tasks_forward_critical_fields(self):
        ...
        self.assertEqual(hist["logical_section.$"], "$.plan.logical_section")
        self.assertEqual(hist["solve_source_manifest_key.$"], "$.plan.solve_source_manifest_key")
        self.assertEqual(hist["prelude_rows.$"], "$.plan.solve_score.prelude_rows")
        self.assertEqual(hist["score_coeff_prelude_rows.$"], "$.plan.solve_score.score_coeff_prelude_rows")
        self.assertEqual(hist["score_param_prelude_rows.$"], "$.plan.solve_score.score_param_prelude_rows")
    ...
    def test_palette_chunk_and_finalize_forward_critical_fields(self):
        ...
        self.assertEqual(chunk["solve_score_spec_version.$"], "$.plan.solve_score.spec_version")
        self.assertEqual(chunk["score_output_channel_count.$"], "$.plan.solve_score.output_channel_count")
        self.assertEqual(chunk["score_output_channels.$"], "$.plan.solve_score.output_channels")
        self.assertEqual(chunk["score_output_has_explicit_outputs.$"], "$.plan.solve_score.has_explicit_outputs")
        self.assertEqual(chunk["color_interpretation.$"], "$.plan.params.color_interpretation")
        ...
        self.assertEqual(chunk["logical_section.$"], "$.plan.logical_section")
        self.assertEqual(chunk["solve_source_manifest_key.$"], "$.plan.solve_source_manifest_key")
        self.assertEqual(chunk["prelude_rows.$"], "$.plan.solve_score.prelude_rows")
        self.assertEqual(chunk["score_coeff_prelude_rows.$"], "$.plan.solve_score.score_coeff_prelude_rows")
        self.assertEqual(chunk["score_param_prelude_rows.$"], "$.plan.solve_score.score_param_prelude_rows")
        ...
        self.assertEqual(finalize["raw_channels.$"], "$.plan.outputs.raw_channels")
        self.assertEqual(finalize["palette_variant_fingerprint.$"], "$.plan.outputs.palette_variant_fingerprint")
        self.assertEqual(finalize["palette_variant_spec_version.$"], "$.plan.outputs.palette_variant_spec_version")
    ...
    def test_extract_attach_branch_is_wired(self):
        ...
        self.assertEqual(attach["associated_palette_color_interpretation.$"], "$.plan.attach.color_interpretation")
        self.assertEqual(attach["associated_palette_raw_key.$"], "$.plan.attach.raw_key")
        self.assertEqual(attach["associated_palette_raw_meta_key.$"], "$.plan.attach.raw_meta_key")
        self.assertEqual(attach["associated_palette_meta_key.$"], "$.plan.attach.meta_key")
