...
def build_cases(workdir, binary):
    ...
    cases = {
        ...
        "param_rply_static": param_payload([["rply", "5", "1", "0.125"]]),
        "param_rply_dynamic": param_payload([["rply", "real(5 + 0*t1)", "1", "0.125"]]),
        "param_star_static": param_payload([["star", "5", "1", "0.5"]]),
        "param_rrect_static": param_payload([["rrect", "2", "1", "4"]]),
