...
class TestDeployPackaging(unittest.TestCase):
    ...
    def test_known_regressions_are_covered(self):
        ...
        self.assertIn("pipeline_programs.py", packaged["handler_render_plan.py"])
        self.assertIn("solve_score_pipeline_programs.py", packaged["handler_render_plan.py"])
        self.assertIn("solve_score_program_source.py", packaged["handler_render_plan.py"])
        ...
        self.assertIn("pipeline_programs.py", packaged["handler_palette_render_plan.py"])
        self.assertIn("solve_score_pipeline_programs.py", packaged["handler_palette_render_plan.py"])
        self.assertIn("solve_score_program_source.py", packaged["handler_palette_render_plan.py"])
        self.assertIn("root_program_source.py", packaged["handler_palette_render_plan.py"])
        self.assertIn("program_source_core.py", packaged["handler_palette_render_plan.py"])
        ...
        self.assertIn("root_pipeline_programs.py", packaged["handler_bilevel.py"])
        self.assertIn("root_program_source.py", packaged["handler_bilevel.py"])
        self.assertIn("program_source_core.py", packaged["handler_bilevel.py"])
        self.assertIn("program_profiles.py", packaged["handler_bilevel.py"])
        self.assertIn("program_profiles.json", packaged["handler_bilevel.py"])
        self.assertIn("root_legacy_registry.json", packaged["handler_bilevel.py"])
        self.assertIn("merged_opcodes.py", packaged["handler_bilevel.py"])
        ...
        self.assertIn("root_pipeline_programs.py", packaged["handler_solve_proximity.py"])
        self.assertIn("solve_score_pipeline_programs.py", packaged["handler_solve_proximity.py"])
        self.assertIn("solve_score_program_source.py", packaged["handler_solve_proximity.py"])
        self.assertIn("root_program_source.py", packaged["handler_solve_proximity.py"])
        self.assertIn("program_source_core.py", packaged["handler_solve_proximity.py"])
        self.assertIn("program_profiles.py", packaged["handler_solve_proximity.py"])
        self.assertIn("program_profiles.json", packaged["handler_solve_proximity.py"])
        self.assertIn("root_legacy_registry.json", packaged["handler_solve_proximity.py"])
        self.assertIn("merged_opcodes.py", packaged["handler_solve_proximity.py"])
        ...
        self.assertIn("root_pipeline_programs.py", packaged["handler_solve_proximity_bench.py"])
        self.assertIn("solve_score_pipeline_programs.py", packaged["handler_solve_proximity_bench.py"])
        self.assertIn("solve_score_program_source.py", packaged["handler_solve_proximity_bench.py"])
        self.assertIn("root_program_source.py", packaged["handler_solve_proximity_bench.py"])
        self.assertIn("program_source_core.py", packaged["handler_solve_proximity_bench.py"])
        self.assertIn("program_profiles.py", packaged["handler_solve_proximity_bench.py"])
        self.assertIn("program_profiles.json", packaged["handler_solve_proximity_bench.py"])
        self.assertIn("root_legacy_registry.json", packaged["handler_solve_proximity_bench.py"])
        self.assertIn("merged_opcodes.py", packaged["handler_solve_proximity_bench.py"])
        ...
        self.assertIn("handler_palette_debug.py", packaged)
        self.assertIn("root_pipeline_programs.py", packaged["handler_palette_debug.py"])
        self.assertIn("root_program_source.py", packaged["handler_palette_debug.py"])
        self.assertIn("program_source_core.py", packaged["handler_palette_debug.py"])
        self.assertIn("program_profiles.py", packaged["handler_palette_debug.py"])
        self.assertIn("program_profiles.json", packaged["handler_palette_debug.py"])
        self.assertIn("root_legacy_registry.json", packaged["handler_palette_debug.py"])
        self.assertIn("merged_opcodes.py", packaged["handler_palette_debug.py"])
        self.assertIn("solve_palette_debug", packaged["handler_palette_debug.py"])
        self.assertIn("raw2jpeg", packaged["handler_palette_debug.py"])
        ...
        self.assertIn("lambda/solve_score_pipeline_programs.py", DEPLOY_TEXT)
        ...
        self.assertIn("root_program_source.py", packaged["handler_storage.py"])
        self.assertIn("solve_score_program_source.py", packaged["handler_storage.py"])
        self.assertIn("program_source_core.py", packaged["handler_storage.py"])
        self.assertIn("program_profiles.py", packaged["handler_storage.py"])
        ...
        self.assertIn("solve_score_pipeline_programs.py", packaged["handler_palette_chunk.py"])
        self.assertIn("solve_score_program_source.py", packaged["handler_palette_chunk.py"])
        ...
        self.assertIn('cp lambda/handler_bilevel.py lambda/shared.py lambda/logical_sections.py lambda/raw_sidecar.py lambda/color_render_contract.py lambda/color_artifact_meta.py lambda/solve_score_chain.py \\', DEPLOY_TEXT)
        self.assertIn('lambda/root_pipeline_programs.py lambda/root_program_source.py lambda/program_source_core.py lambda/program_profiles.py lambda/program_profiles.json \\', DEPLOY_TEXT)
        self.assertIn('lambda/root_legacy_registry.json lambda/merged_opcodes.py "$BILEVEL_DIR/"', DEPLOY_TEXT)
        ...
        self.assertIn("solve_score_pipeline_programs.py", packaged["handler_palette_finalize.py"])
        self.assertIn("solve_score_program_source.py", packaged["handler_palette_finalize.py"])
        self.assertIn("color_render_contract.py", packaged["handler_palette_finalize.py"])
        self.assertIn("palette_names.py", packaged["handler_palette_finalize.py"])
        self.assertIn("tri_palette_names_generated.py", packaged["handler_palette_finalize.py"])
        self.assertIn("long_palette_names_generated.py", packaged["handler_palette_finalize.py"])
        ...
        self.assertIn("param_program_source.py", packaged["handler_coeffgen.py"])
        self.assertIn("program_source_core.py", packaged["handler_coeffgen.py"])
        self.assertIn("program_profiles.py", packaged["handler_coeffgen.py"])
        self.assertIn("program_profiles.json", packaged["handler_coeffgen.py"])
        ...
        self.assertIn("pipeline_programs.py", packaged["handler_coeffgen.py"])
        ...
        self.assertIn("param_program_source.py", packaged["handler_compute_preview.py"])
        self.assertIn("param_legacy_registry.json", packaged["handler_compute_preview.py"])
        self.assertIn("program_source_core.py", packaged["handler_compute_preview.py"])
        self.assertIn("program_profiles.py", packaged["handler_compute_preview.py"])
        self.assertIn("program_profiles.json", packaged["handler_compute_preview.py"])
        ...
        self.assertIn("pipeline_programs.py", packaged["handler_compute_preview.py"])
        self.assertIn("program_compile_helpers.py", packaged["handler_compute_preview.py"])
        ...
        self.assertIn("param_program_source.py", packaged["handler_param_debug.py"])
        self.assertIn("param_legacy_registry.json", packaged["handler_param_debug.py"])
        self.assertIn("program_source_core.py", packaged["handler_param_debug.py"])
        self.assertIn("program_profiles.py", packaged["handler_param_debug.py"])
        self.assertIn("program_profiles.json", packaged["handler_param_debug.py"])
        self.assertIn("coeff_program_chain.py", packaged["handler_param_debug.py"])
        self.assertIn("coeff_program_source.py", packaged["handler_param_debug.py"])
        self.assertIn("coeff_legacy_registry.json", packaged["handler_param_debug.py"])
        self.assertIn("program_compile_helpers.py", packaged["handler_param_debug.py"])
        ...
        self.assertIn("root_pipeline_programs.py", packaged["handler_render_lores_preview.py"])
        self.assertIn("solve_score_pipeline_programs.py", packaged["handler_render_lores_preview.py"])
        self.assertIn("solve_score_program_source.py", packaged["handler_render_lores_preview.py"])
        self.assertIn("root_program_source.py", packaged["handler_render_lores_preview.py"])
        self.assertIn("program_source_core.py", packaged["handler_render_lores_preview.py"])
        self.assertIn("program_profiles.py", packaged["handler_render_lores_preview.py"])
        self.assertIn("program_profiles.json", packaged["handler_render_lores_preview.py"])
        self.assertIn("root_legacy_registry.json", packaged["handler_render_lores_preview.py"])
        self.assertIn("merged_opcodes.py", packaged["handler_render_lores_preview.py"])
        ...
        # the frozen sculpture viewer template ships inside the lores zip so
        # saved sculptures can copy it into their sculptures/{id}/ prefix
        self.assertIn('sculpture.html "$RENDER_LORES_PREVIEW_DIR/"', DEPLOY_TEXT)
        ...
        self.assertIn("param_program_source.py", packaged["handler_compute_plan.py"])
        ...
        self.assertIn("program_source_core.py", packaged["handler_compute_plan.py"])
        self.assertIn("program_profiles.py", packaged["handler_compute_plan.py"])
        self.assertIn("program_profiles.json", packaged["handler_compute_plan.py"])
        self.assertIn("pipeline_programs.py", packaged["handler_compute_plan.py"])
        self.assertIn("solve_score_pipeline_programs.py", packaged["handler_compute_plan.py"])
        self.assertIn("program_compile_helpers.py", packaged["handler_compute_plan.py"])
        ...
        self.assertIn("solve_score_program_source.py", packaged["handler_pdf_artifact.py"])
        self.assertIn("coeff_program_source.py", packaged["handler_pdf_artifact.py"])
        self.assertIn("param_program_source.py", packaged["handler_pdf_artifact.py"])
        self.assertIn("root_program_source.py", packaged["handler_pdf_artifact.py"])
        self.assertIn("pipeline_programs.py", packaged["handler_pdf_artifact.py"])
        self.assertIn("root_pipeline_programs.py", packaged["handler_pdf_artifact.py"])
        self.assertIn("solve_score_pipeline_programs.py", packaged["handler_pdf_artifact.py"])
        self.assertIn("coeff_program_chain.py", packaged["handler_pdf_artifact.py"])
        self.assertIn("param_program_chain.py", packaged["handler_pdf_artifact.py"])
        self.assertIn("merged_opcodes.py", packaged["handler_pdf_artifact.py"])
        self.assertIn("program_source_core.py", packaged["handler_pdf_artifact.py"])
        self.assertIn("program_profiles.py", packaged["handler_pdf_artifact.py"])
        self.assertIn("program_profiles.json", packaged["handler_pdf_artifact.py"])
        self.assertIn("coeff_legacy_registry.json", packaged["handler_pdf_artifact.py"])
        self.assertIn("param_legacy_registry.json", packaged["handler_pdf_artifact.py"])
    ...
    def test_phase1_phase2_files_exist_and_are_wired(self):
        ...
        self.assertIn("gen_program_profiles.py --check", predeploy_text)
        self.assertIn("gen_merged_opcodes.py --check", predeploy_text)
        self.assertIn("gen_param_vocab.py --check", predeploy_text)
        self.assertIn("gen_coeff_vocab.py --check", predeploy_text)
        self.assertIn("gen_solve_score_vocab.py --check", predeploy_text)
        self.assertIn("lambda/gen_program_profiles.py", DEPLOY_TEXT)
        self.assertIn("lambda/gen_merged_opcodes.py", DEPLOY_TEXT)
        self.assertIn("lambda/gen_param_vocab.py", DEPLOY_TEXT)
        self.assertIn("lambda/gen_coeff_vocab.py", DEPLOY_TEXT)
        self.assertIn("lambda/gen_solve_score_vocab.py", DEPLOY_TEXT)
        self.assertIn('"program_profiles_js.js"', DEPLOY_TEXT)
        self.assertIn('"merged_opcodes_js.js"', DEPLOY_TEXT)
        self.assertIn('"param_vocab_js.js"', DEPLOY_TEXT)
        self.assertIn('"coeff_vocab_js.js"', DEPLOY_TEXT)
        self.assertIn('"solve_score_vocab_js.js"', DEPLOY_TEXT)
        ...
        self.assertIn("tests/test_program_m3_oracles.py", predeploy_text)
        self.assertIn("tests/test_coeff_program_drift.py", predeploy_text)
