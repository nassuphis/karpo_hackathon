...
package_render_plan_zip() {
    ...
    cp lambda/handler_render_plan.py lambda/shared.py \
       ...
       lambda/pipeline_programs.py lambda/root_pipeline_programs.py lambda/solve_score_pipeline_programs.py lambda/root_program_source.py lambda/program_source_core.py lambda/registry_common.py \
...
rm -rf "$STORAGE_DIR"
mkdir -p "$STORAGE_DIR"
cp lambda/handler_storage.py lambda/shared.py lambda/color_artifact_meta.py lambda/solve_score_chain.py lambda/book_describe.py \
   lambda/solve_score_program_source.py \
   lambda/param_program_chain.py lambda/param_program_source.py lambda/param_legacy_registry.json \
   lambda/coeff_program_chain.py lambda/cp437_font.py lambda/coeff_program_source.py lambda/coeff_legacy_registry.json lambda/structural_chips.json \
   lambda/root_program_source.py \
   lambda/program_source_core.py lambda/registry_common.py lambda/program_profiles.py lambda/program_v2_translate.py \
...
# ViewSnap uses deterministic byte admission only. Runtime durations are
# reported as telemetry and never gate a render.
...
cp lambda/handler_pdf_artifact.py lambda/shared.py lambda/color_artifact_meta.py lambda/solve_score_chain.py \
   ...
   lambda/coeff_program_chain.py lambda/cp437_font.py lambda/param_program_chain.py lambda/merged_opcodes.py \
   lambda/program_source_core.py lambda/registry_common.py lambda/program_profiles.py lambda/program_profiles.json \
